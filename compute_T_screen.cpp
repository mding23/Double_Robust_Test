...
// [[Rcpp::export]]
List compute_T_cpp_w_truncation_w_R_screen( int const n, int const p, int const m, const arma::mat& X, const arma::mat& Y, const arma::mat& fitted, const arma::vec& sigmaHat, const arma::cube& A_inv_partial_log_f, const arma::cube& R, const arma::vec& screen_vec ){
